...
export const sceneIdToEntityId = {};
export const eulers = rots.map((r) => new Euler(r[0], r[1], r[2]));
export function updateColorRegister(components) {
    if (components.color) {
...
function updateMatrixRotation(rotation) {
...
export function updateMatrixRegister(components) {
