...
fetch("/sims/build/webComponents/xitionWipe.html")
    ...
    .then((text) => customElements.define("xition-wipe", class XitionWipe extends HTMLElement {
    handler(e) { }
    ...
    connectedCallback() {
        ...
        blah.style.setProperty("--preset-gradient", this.getPresetGradient(preset));
    }
