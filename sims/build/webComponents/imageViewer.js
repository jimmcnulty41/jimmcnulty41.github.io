"use strict";
const baseUrl = "https://sketchery-store.nyc3.cdn.digitaloceanspaces.com/enhanced/";
let cache = {};
function registerIntoCache(name, blobUrl) {
    cache[name] = blobUrl;
}
...
class ImageViewer extends HTMLElement {
    ...
    getDisplayDims() {
        ...
        const smallerWindowDim = Math.min(window.innerWidth, window.innerHeight - 128);
    ...
    setImage(name) {
        this.img.src = this.localUrls[name];
        this.img.onload = () => {
