import {
  ...
  FileLoader,
  ImageBitmapLoader,
} from "./types/three/src/Three";

import { DRACOLoader } from "./types/three/examples/jsm/loaders/DRACOLoader";
import { KTX2Loader } from "./types/three/examples/jsm/loaders/KTX2Loader";
